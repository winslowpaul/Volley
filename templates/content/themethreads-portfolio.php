...
<article <?php themethreads_helper()->attr( 'post' ) ?>>
	...
	<header class="entry-header">
		<h1 <?php themethreads_helper()->attr( 'entry-title' ); ?>><?php single_post_title(); ?></h1>
	</header><!-- .entry-header -->
	<?php endif; ?>
	...
	<?php edit_post_link( esc_html__( 'Edit', 'volley' ), '<footer class="entry-footer"><span class="edit-link">', '</span></footer><!-- .entry-footer -->' ); ?>
