...
// Fallback
if( !class_exists( 'LD_PortfolioListing' ) ) {
	// Start the Loop.
	...
	if( !empty( $links ) ) {
		...
		printf( '<div class="blog-nav"><nav aria-label="'. esc_attr__( 'Page navigation', 'volley' ).'"><ul class="pagination"><li>%s</li></ul></nav></div>', join( "</li>\n\t<li>", $links ) );
	}
