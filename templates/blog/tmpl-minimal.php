...
<div class="themethreads-blog-item-inner">
	...
	<header class="themethreads-lp-header">
		<h2 class="themethreads-lp-title font-weight-normal mb-1">
	...
	<footer class="themethreads-lp-footer">
		<div class="ld-post-author">
			...
			<div class="ld-author-info">
				...
				<time class="themethreads-lp-date text-uppercase ltr-sp-1 my-0" datetime="<?php echo get_the_date( 'c' ); ?>"><?php the_time( get_option( 'date_format' ) ); ?></time>
