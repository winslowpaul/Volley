...
<nav class="post-nav">
	...
	<h2 class="screen-reader-text"><?php echo esc_html__( 'Post navigation', 'volley' ) ?></h2>
	...
	<div class="nav-previous">
		<a href="<?php echo esc_url( $prev_post_link ); ?>" rel="prev">
			...
			<span class="screen-reader-text"><?php esc_html_e( 'Previous Article', 'volley' ); ?></span>
			<span aria-hidden="true" class="nav-subtitle"><?php esc_html_e( 'Previous Article', 'volley' ); ?></span>
	...
	<div class="nav-next">
		<a href="<?php echo esc_url( $next_post_link ); ?>" rel="next">
			...
			<span class="screen-reader-text"><?php esc_html_e( 'Next Article', 'volley' ); ?></span>
			<span aria-hidden="true" class="nav-subtitle"><?php esc_html_e( 'Next Article', 'volley' ); ?></span>
