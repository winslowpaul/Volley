...
$style = themethreads_helper()->get_option( 'post-style', 'cover-spaced' );
$style = !empty( $style ) ? $style : 'cover-spaced';

$figure_atts     = array();
$enable_parallax = themethreads_helper()->get_option( 'post-parallax-enable' );
	...
	?>
		...
		<div class="blog-single-cover" data-inview="true" data-inview-options='{ "onImagesLoaded": true }'>
			<div class="carousel-container cover-carousel carousel-nav-floated carousel-nav-circle carousel-nav-bordered">
				<div class="carousel-items row mx-0" id="blog-cover-carousel" data-threads-flickity='{ "prevNextButtons": true, "navArrow": "6", "navOffsets": { "prev": 15, "next": 15 } }'>
...
elseif( 'cover' === $style || 'cover-spaced' === $style  ) {
	...
	if( 'gallery' == $format && $gallery_ids )  { 
		...
		<div class="carousel-container cover-carousel carousel-nav-circle carousel-nav-bordered">
			...
			<div class="carousel-items row mx-0" id="blog-cover-carousel" data-threads-flickity='{ "prevNextButtons": true, "buttonsAppendTo": ".blog-single-details-extra", "navArrow": "6" }'>
		...
		?>
			...
			<div class="carousel-container cover-carousel carousel-nav-floated carousel-nav-circle carousel-nav-bordered">
				...
				<div class="carousel-items row" id="blog-cover-carousel" data-threads-flickity='{ "prevNextButtons": true, "navArrow": "6", "navOffsets": { "prev": 30, "next": 30 } }'>	
				<?php foreach( $gallery_ids as $image ) {  ?>
...
elseif( 'slider' === $style ) { 
	...
	$gallery = get_post_meta( get_the_ID(), 'themethreads-post-slider', true );
	if( ! empty( $gallery ) ) {
...
<div class="carousel-container cover-carousel">
	...
	<div class="carousel-items row" id="blog-cover-carousel" data-threads-flickity='{ "prevNextButtons": true, "buttonsAppendTo": "#blog-cover-carousel-thumbs", "navArrow": "1" }'>
