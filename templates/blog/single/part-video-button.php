...
$enable = themethreads_helper()->get_option( 'post-video-btn-enable' );
if( 'on' !== $enable ) {
	return;
}
$url   = themethreads_helper()->get_option( 'post-video-btn-url' );
$label = themethreads_helper()->get_option( 'post-video-btn-label' );
