		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="pf-single-contents">
					...
					<?php themethreads_portfolio_media() ?>
					...
					<div class="row d-md-flex align-items-center">
						...
						<div class="col-md-6">
							...
							<div class="pf-single-header pull-up bg-solid">
								...
								<?php themethreads_portfolio_the_content() ?>
				
								<div class="clearfix mb-3"></div>
				
								<div class="pf-info d-lg-flex justify-content-between">
									<?php themethreads_portfolio_date() ?>
									<?php themethreads_portfolio_atts() ?>
								</div><!-- /.pf-info -->
						...
						<div class="col-md-6 text-md-right mb-5 mb-md-0">
							...
							<?php if( function_exists( 'themethreads_portfolio_share' ) ) : ?>
								<small class="text-uppercase ltr-sp-1 mr-3"><?php esc_html_e( 'Share on', 'volley' ); ?></small>
								<?php themethreads_portfolio_share( get_post_type() ); ?>
							<?php endif; ?>
							</div>
				
							<?php themethreads_render_post_nav( get_post_type() ) ?>
