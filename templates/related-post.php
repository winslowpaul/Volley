...
$related_style = themethreads_helper()->get_option( 'post-related-style' );
$col = '3';
				...
				<div class="col-md-<?php echo esc_attr( $col ) ?> col-sm-12">
					...
					<article class="related-post related-post-alt">
						...
						<figure class="related-post-image" data-responsive-bg="true">
							<?php themethreads_the_post_thumbnail( 'themethreads-related-post', '', false ); ?>
					...
					<article class="related-post">
						...
						<header class="related-post-header">
							...
							<ul class="related-post-categories">
								<li><?php echo themethreads_get_category(); ?></li>
							</ul>
						</header>
