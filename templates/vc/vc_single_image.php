...
$caption = $img_link_large = $link = $img_link_target = $alignment = $el_class = $el_id = $css_animation = $style = $external_style = $border_color = $css = $invisible = $enable_opacity = $opacity = '';
...
$themethreads_class = uniqid( 'themethreads_vc_single_image-' );
$css_class .= ' ' . $themethreads_class .' ';
$custom_style = $selector = '';

if( !empty( $image_max_width ) ) {
	$selector .= '.' . $themethreads_class . ' figure img, .'. $themethreads_class . ' figure svg{ max-width:' . $image_max_width . '}';
}
if( $invisible ) {
	$css_class .= ' invisible ';
}
if( $enable_opacity ) {
	...
	$selector .= '.' . $themethreads_class . '{ opacity:' . $opacity . '}';
}
if( !empty( $selector ) ) {
...
';
echo apply_filters( 'themethreads_vc_single_image', $output );