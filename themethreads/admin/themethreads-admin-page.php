...
* The ThemeThreads_Admin_Page base class
*/

if( !defined( 'ABSPATH' ) )
	exit; // Exit if accessed directly

class ThemeThreads_Admin_Page extends ThemeThreads_Base {
	...
	public function register_page() {
		...
		if( ! $this->parent ) {
			add_menu_page(
				...
				$this->id,
				array( $this, 'display' ),
				get_template_directory_uri() . '/themethreads/assets/img/themethreads-menu-logo.png',
				$this->position
			);
		}
		else {
