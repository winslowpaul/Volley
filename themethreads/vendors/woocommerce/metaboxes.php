 ...
 * @return void
 */
function themethreads_add_custom_general_fields() {
  ...
  echo '<div class="options_group">';
	...
	woocommerce_wp_textarea_input(
		array(
			'id'          => '_custom_label',
			'label'       => esc_html__( 'Custom label', 'volley' ),
			'desc_tip'    => 'true',
			'description' => esc_html__( 'Input a custom label for the product', 'volley' )
		)
	);
	echo '</div>';
 ...
 * @return void
 */
function themethreads_add_custom_general_fields_save( $post_id ){
 ...
 */
function themethreads_edit_background_meta_field( $term ) {
...
?>
	<tr class="form-field">
		<th scope="row">
			<label for="term-background-color"><?php esc_html_e( 'Background Color', 'volley' ); ?></label>
			<td>
				...
				<p class="description"><?php esc_html_e( 'Select a background for product category label', 'volley' ); ?></p>
			</td>
		</th>
	</tr>
<?php
...
// Save the field
function themethreads_save_tax_meta( $term_id ){
 ...
 */
function themethreads_create_background_meta_field() {
	...
	<div class="form-field term-background-wrap">
		...
		<p><?php esc_html_e( 'Select a background for product category label', 'volley' ); ?></p>
	</div>
<?php }