...
* The ThemeThreads_Theme_Options initiate the theme option machine.
*/

if( !defined( 'ABSPATH' ) )
	exit; // Exit if accessed directly

class ThemeThreads_Theme_Options extends ThemeThreads_Base {
	...
	public function set_arguments() {
		...
		$this->args = array(
	        ...
	        'menu_title'           => esc_html__( 'Theme Options', 'volley' ), //
	        'page_title'           => esc_html__( 'Theme Options', 'volley' ), //

			'global_variable'      => 'themethreads_options',
	        ...
	        'page_parent'          => 'themethreads',
	        'page_permissions'     => 'manage_options',
	        'page_slug'            => 'themethreads-theme-options',
	...
	public function set_sections() {
		...
		$sections = get_theme_support( 'themethreads-theme-options' );
		...
		foreach( $sections as $section ) {
			$file = "theme-options/themethreads-{$section}.php";
