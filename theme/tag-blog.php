<?php
/**
 * ThemeThreads_TagBlog class for blog posts page and blog archives
 */

class ThemeThreads_TagBlog extends LD_Blog {
	...
	public function __construct() {
		$this->atts = array(
			'style' => themethreads_helper()->get_option( 'tag-blog-style' ),

			'enable_parallax' => themethreads_helper()->get_option( 'tag-blog-enable-parallax' ),
			'show_meta' => themethreads_helper()->get_option( 'tag-blog-show-meta' ),
			'meta_type' => themethreads_helper()->get_option( 'tag-blog-meta-type' ),
			'one_category' => themethreads_helper()->get_option( 'tag-blog-one-category' ),
			'post_excerpt_length' => themethreads_helper()->get_option( 'tag-blog-excerpt-length' ),
			'grid_columns' => '2',
