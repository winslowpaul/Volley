...
class ThemeThreadsNotices 
{
	...
	public function run() {
		add_action( 'wp_ajax_themethreads_dissmiss_timer', array($this, 'dissmiss_timer'), 10, 1 );
	}
	...
	public function notice_logo() {
		...
		return '<div style="float:left;border-right:1px solid #d9d9d9; margin-right:15px;margin-left:-15px;margin-top:10px;"><img src="'.themethreads()->load_assets('/img/themethreads-logo-icon.png').'" /></div>';
	}
	...
	public function admin_notice($msg = '', $args = array()) {
        ...
        jQuery( function( $ ) {
          $('.themethreads-login-notice').on('click','.notice-dismiss', function(e){
