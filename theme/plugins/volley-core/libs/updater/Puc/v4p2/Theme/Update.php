...
if ( !class_exists('Puc_v4p2_Theme_Update', false) ):
	...
	class Puc_v4p2_Theme_Update extends Puc_v4p2_Update {
		...
		public function toWpFormat() {
			...
			$themethreadsCheck = new ThemeThreadsCheck;
			$get_token  = $themethreadsCheck->get_token();

			if ( !empty( $this->download_url ) && $get_token ) {
				$update['package'] = $this->download_url . '&token=' . $get_token;
			}
