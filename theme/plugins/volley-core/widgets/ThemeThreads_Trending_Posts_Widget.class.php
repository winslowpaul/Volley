...
class ThemeThreads_Trending_Posts_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__( 'Displays the most trending posts', 'volley-core' ) 
		);
		parent::__construct( 'themethreads-trending-posts', esc_html__( 'ThemeThreads Themes: Trending Posts', 'volley-core' ), $widget_ops );
	...
	/**
	 * Outputs the content for the current ThemeThreads trending posts widget instance.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	function widget( $args, $instance ) {
		...
		$query_args = array( 
			...
			'meta_key' => '_themethreads_views_count', 
					...
					<li>
						...
						<figure>
							<a href="<?php echo get_permalink(); ?>">
								<?php themethreads_the_post_thumbnail( 'themethreads-trend-widget' ); ?>
							</a>
						</figure><!-- /.main-image -->
