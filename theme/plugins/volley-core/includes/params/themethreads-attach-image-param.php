 ...
 */
vc_add_shortcode_param( 'themethreads_attach_image', 'themethreads_attach_images_form_field' );
function themethreads_attach_images_form_field( $settings, $value ) {
	...
	$output .= '<a class="gallery_widget_add_images" href="#" use-single="true" title="'
		. esc_html__( 'Add image', 'volley-core' ) . '"><i class="vc-composer-icon vc-c-icon-add"></i>' . esc_html__( 'Add image', 'volley-core' ) . '</a>'; //class: button
