 ...
 * @property mixed data
 */
class ThemeThreads_Responsive_Alignment {
	...
	public function __construct( $settings, $value ) {
		...
		$this->column_width_list = array(
			...
			esc_html__( 'Justify', 'volley-core' ) => 'justify',
		);
	}
	...
	public function render() {
		...
		<div class="vc_column-offset" data-column-offset="true">
			...
			<table class="vc_table vc_column-offset-table">
				<tr>
					<th>
						<?php esc_html_e( 'Device', 'volley-core' ) ?>
					</th>
					<th>
						<?php esc_html_e( 'Alignment', 'volley-core' ) ?>
					</th>
				</tr>
...
<?php		
	...
	public function alignmentControl( $size ) {
		$prefix = 'text-' . $size . '-';
		$empty_label = 'xs' === $size ? esc_html__( 'No offset', 'volley-core' ) : esc_html__( 'Inherit from smaller', 'volley-core' );
 ...
 * @return string
 */
function themethreads_responsive_alignment_form_field( $settings, $value ) {
	$responsive_alignment = new ThemeThreads_Responsive_Alignment( $settings, $value );

	return $responsive_alignment->render();
}
vc_add_shortcode_param( 'responsive_alignment', 'themethreads_responsive_alignment_form_field' );