...
vc_add_shortcode_param( 'themethreads_checkbox', 'themethreads_param_checkbox' );
function themethreads_param_checkbox( $settings, $value ) {
	...
	if ( ! empty( $values ) ) {
		foreach ( $values as $label => $v ) {
			...
			$output .= '<div class="' . $columns . 'themethreads-checkbox-with-label"><label class="vc_checkbox-label"><input id="'
