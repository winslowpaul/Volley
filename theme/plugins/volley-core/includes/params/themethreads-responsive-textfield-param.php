 ...
 * @property mixed data
 */
class ThemeThreads_Responsive_Textfield {
		...
		<div class="vc_column-offset">
			...
			<table class="vc_table vc_column-offset-table">
				<tr>
					...
					<th>
						<?php esc_html_e( 'Items', 'volley-core' ) ?>
					</th>
					<th>
						<?php esc_html_e( 'Spacing', 'volley-core' ) ?>
					</th>
				</tr>
 ...
 * @return string
 */
function themethreads_responsive_textfield_form_field( $settings, $value ) {
	$responsive_alignment = new ThemeThreads_Responsive_Textfield( $settings, $value );

	return $responsive_alignment->render();
}
vc_add_shortcode_param( 'responsive_textfield', 'themethreads_responsive_textfield_form_field' );