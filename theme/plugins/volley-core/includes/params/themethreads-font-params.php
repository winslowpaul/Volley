...
function themethreads_get_font( $slug, $atts, $param, $tag = 'h6' ) {
...
function themethreads_get_font_params( $prefix, $title, $dependency = array() ) {
...
if ( !function_exists( 'themethreads_google_vc_fonts' ) ) {

	function themethreads_google_vc_fonts( $fonts_list ) {
		...
		$amiri->font_family_description = esc_html_e( 'Select font family', 'volley-core' );
		$amiri->font_style_description = esc_html_e( 'Select font styling', 'volley-core' );
		...
		$teko->font_family_description = esc_html_e( 'Select font family', 'volley-core' );
		$teko->font_style_description = esc_html_e( 'Select font styling', 'volley-core' );
		...
		$rubik->font_family_description = esc_html_e( 'Select font family', 'volley-core' );
		$rubik->font_style_description = esc_html_e( 'Select font styling', 'volley-core' );
		...
		$poppins->font_family_description = esc_html_e( 'Select font family', 'volley-core' );
		$poppins->font_style_description = esc_html_e( 'Select font styling', 'volley-core' );
...
add_filter( 'vc_google_fonts_get_fonts_filter', 'themethreads_google_vc_fonts' );
