...
class LD_Content_Box_Table extends LD_Shortcode {
	...
	public function __construct() {
		...
		$this->title           = esc_html__( 'Fancy Box Table', 'volley-core' );
		$this->description     = esc_html__( 'Fancy box table container', 'volley-core' );
	...
	public function get_params() {
		...
		$this->params = array(
			array(
				...
				'heading'     => esc_html__( 'Header?', 'volley-core' ),
				'description' => esc_html__( 'Check to enable the row as header of the table', 'volley-core' ),
