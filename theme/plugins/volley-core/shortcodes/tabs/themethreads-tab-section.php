<?php
/**
* Shortcode ThemeThreads Tab Section
*/
...
class LD_Tab_Section extends LD_Shortcode {
	...
	public function __construct() {
		...
		$this->title         = esc_html__( 'Tab Section', 'volley-core' );
		$this->description   = esc_html__( 'Section for Tabs.', 'volley-core' );
		...
		$this->params = array_merge(
			array(
				...
				array(
					'type'       => 'textfield',
					'param_name' => 'desc',
					'heading'    => esc_html__( 'Short Description', 'volley-core' ),
					'description' => esc_html__( 'Add short description for tab, works only for some tabs styles', 'volley-core' ),
				),
			...
			themethreads_get_icon_params( false, '', array( 'fontawesome', 'linea' ), array( 'align', 'color', 'size', 'hcolor' ) )
		);
