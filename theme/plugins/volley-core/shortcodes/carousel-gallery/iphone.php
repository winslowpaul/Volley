		...
		<div class="mockup-container">
			<div class="mockup-inner">
				<figure class="text-center">
					<img src="<?php echo get_template_directory_uri() . '/assets/img/mockups/phone/mockup-1.png' ?>" alt="<?php esc_attr_e( 'Iphone', 'volley-core' ) ?>">
				</figure>
			</div><!-- /.mockup-inner -->
		...
		<div class="mockup-content-container">
			<div class="mockup-content-inner">
				...
				<div class="carousel-container carousel-nav-floated carousel-nav-middle carousel-nav-bordered carousel-nav-circle carousel-nav-sm">
					<div class="carousel-items row" data-threads-flickity='{ "groupCells": false, "wrapAround": true, "cellAlign": "center" }'>					
					<?php
