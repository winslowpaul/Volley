	...
	<div class="ld-carousel-laptop-inner">
		...
		<div class="mockup-container">
			<div class="mockup-inner">
				<figure>
					<img src="<?php echo get_template_directory_uri() . '/assets/img/mockups/laptop/mockup-1.png'; ?>" alt="<?php esc_html_e( 'Laptop', 'volley-core' ); ?>">
				</figure>
			</div><!-- /.mockup-inner -->
		...
		<div class="mockup-content-container">
			...
			<div class="mockup-content-inner">
				...
				<div class="carousel-container carousel-nav-floated carousel-nav-middle carousel-nav-bordered carousel-nav-circle carousel-nav-sm">
					...
					<div class="carousel-items row" data-threads-flickity='{ "prevNextButtons": true, "navArrow": 6, "parallax": true }'>
					<?php
