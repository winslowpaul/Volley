<?php
/**
* Shortcode ThemeThreads Testimonial
*/
...
class LD_Testimonial extends LD_Shortcode {
	...
	public function __construct() {
		...
		$this->title       = esc_html__( 'Testimonial', 'volley-core' );
		$this->description = esc_html__( 'Add testimonial', 'volley-core' );
	...
	public function get_params() {
		...
		$url = themethreads_addons()->plugin_uri() . '/assets/img/sc-preview/testimonial/';
		...
		$this->params = array(
			...
			array(
				...
				'value' => array(
					...
					array(
						'label' => esc_html__( 'Testimonial 02', 'volley-core' ),
						'value' => 'testi_s02',
						'image' => $url . 'testi-2.jpg'
					),
					array(
						'label' => esc_html__( 'Testimonial 03', 'volley-core' ),
						'value' => 'testi_s03',
						'image' => $url . 'testi-3.jpg'
					),
					array(
						'label' => esc_html__( 'Testimonial 04', 'volley-core' ),
						'value' => 'testi_s04',
						'image' => $url . 'testi-4.jpg'
					),
					array(
						'label' => esc_html__( 'Testimonial 05', 'volley-core' ),
						'value' => 'testi_s05',
						'image' => $url . 'testi-5.jpg'
					),
					array(
						'label' => esc_html__( 'Testimonial 06', 'volley-core' ),
						'value' => 'testi_s06',
						'image' => $url . 'testi-6.jpg'
					),
					array(
						'label' => esc_html__( 'Testimonial 07', 'volley-core' ),
						'value' => 'testi_s07',
						'image' => $url . 'testi-7.jpg'
					),
					array(
						'label' => esc_html__( 'Testimonial 08', 'volley-core' ),
						'value' => 'testi_s08',
						'image' => $url . 'testi-8.jpg'
					),
					array(
						'label' => esc_html__( 'Testimonial 09', 'volley-core' ),
						'value' => 'testi_s11',
			...
			array(
				...
				'heading'    => esc_html__( 'Avatar Position', 'volley-core'  ),
				'value'      => array(
			...
			array(
				...
				'heading'    => esc_html__( 'Details size', 'volley-core' ),
				'description' => esc_html__( 'Sizes of heading and position proportionaly', 'volley-core' ),
				'value' => array(
					esc_html__( 'Default', 'volley-core' ) => '',
					esc_html__( 'Small', 'volley-core' )  => 'testimonial-details-sm',
					esc_html__( 'Large', 'volley-core' )   => 'testimonial-details-lg',
					esc_html__( 'Extra Large', 'volley-core' )   => 'testimonial-details-xl'
				),
				'edit_field_class' => 'vc_col-sm-6'
			...
			array(
				...
				'heading'    => esc_html__( 'Additional', 'volley-core' ),
			),
			array(
				'type'        => 'checkbox',
				'param_name'  => 'enable_shadow',
				'heading'     => esc_html__( 'Enable Shadow?', 'volley-core' ),
			...
			array(
				...
				'heading'     => esc_html__( 'Data/Time', 'volley-core' ),
				'dependency'  => array(
					'element' => 'style',
			...
			array(
				...
				'only_solid'  => true,
				'heading'     => esc_html__( 'Position color', 'volley-core' ),
				'description' => esc_html__( 'Pick a color for the position', 'volley-core' ),
				'group'       => esc_html__( 'Design Options', 'volley-core' ),
				'edit_field_class' => 'vc_col-sm-6'
			),
			array(
				...
				'description' => esc_html__( 'Pick a primary color for the testimonial box', 'volley-core' ),
				'group'       => esc_html__( 'Design Options', 'volley-core' ),
				'dependency'  => array(
					'element' => 'style',
			...
			array(
				...
				'description' => esc_html__( 'Pick a background color for the testimonial box', 'volley-core' ),
				'group'       => esc_html__( 'Design Options', 'volley-core' ),
				'dependency'  => array(
					'element' => 'style',
			...
			array(
				...
				'heading'     => esc_html__( 'Background Fill color', 'volley-core' ),
				'description' => esc_html__( 'Pick a background fill color for the testimonial box inside the carousel active item', 'volley-core' ),
				'group'       => esc_html__( 'Design Options', 'volley-core' ),
				'dependency'  => array(
					'element' => 'style',
					'value'   => array( 'testi_s08' ),
			...
			array(
				...
				'only_solid'  => true,
				'heading'     => esc_html__( 'Star/Rating color', 'volley-core' ),
				'description' => esc_html__( 'Pick a color for the star/rating', 'volley-core' ),
				'group'       => esc_html__( 'Design Options', 'volley-core' ),
				'dependency'  => array(
					'element' => 'style',
					'value'   => array( 'testi_s02', 'testi_s08' ),
	...
	protected function get_avatar( $classnames = null ) {
		...
		if( preg_match( '/^\d+$/', $this->atts['avatar'] ) ){
			$avatar = themethreads_get_image( $this->atts['avatar'] );
			// check
			if( ! $avatar ) {
				return;
			}
	...
	protected function generate_css() {
		...
		if( !empty( $title_color ) ) {
			$elements[ themethreads_implode( '%1$s .testimonial-details h5' ) ]['color'] = $title_color;
		}
		if( !empty( $pos_color ) ) {
			$elements[ themethreads_implode( '%1$s .testimonial-details h6' ) ]['color'] = $pos_color;
		}
		if( !empty( $star_color ) ) {
			$elements[ themethreads_implode( '%1$s .star-rating li' ) ]['color'] = $star_color;
		}
		if( 'testi_s11' === $style ) {
			if( !empty( $fill_color ) ) {
				$elements[ themethreads_implode( '%1$s:after' ) ]['background'] = $fill_color;
				$elements[ themethreads_implode( '%1$s .testimonial-quote-mark svg' ) ]['fill'] = $fill_color;
			}
		}
		else {
			if( !empty( $fill_color ) ) {
				$elements[ themethreads_implode( '%1$s.testimonial-quote-filled .testimonial-quote, %1$s.testimonial-whole-filled' ) ]['background'] = $fill_color;
			}
		}
		if( !empty( $primary_color ) ) {
			$elements[ themethreads_implode( '%1$s:after' ) ]['background'] = $primary_color;
		}
		if( !empty( $fill_bg_color ) ) {
			$elements[ themethreads_implode( '%1$s:after' ) ]['background'] = $fill_bg_color;
		}
