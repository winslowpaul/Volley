...
$GLOBALS['wp_query'] = new WP_Query( $this->build_query() );		
	echo '<div class="carousel-items row" data-threads-flickity=\'{ "filters": "#' . $filter_id . '", "prevNextButtons": true, "wrapAround": false, "navArrow": 1, "fullwidthSide": true, "navOffsets": { "nav": {"left": -10, "top": 200} } }\'>';
