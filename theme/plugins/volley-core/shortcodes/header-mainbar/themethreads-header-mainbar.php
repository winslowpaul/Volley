...
class LD_Header_Mainbar extends LD_Shortcode {
	...
	public function __construct() {
		...
		$this->title           = esc_html__( 'Header Mainbar', 'volley-core' );
		$this->description     = esc_html__( 'Header Mainbar container', 'volley-core' );
		$this->icon            = 'fa fa-file-image-o';
		$this->category        = esc_html__( 'Header Containers', 'volley-core' );
