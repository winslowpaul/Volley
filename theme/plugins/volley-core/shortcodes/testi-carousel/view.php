...
<div class="carousel-container carousel-nav-floated <?php echo $quotesID ?>">
	...
	<div class="carousel-items row testimonials-quote-only" data-threads-flickity='{ "prevNextButtons": true, "buttonsAppendTo": ".<?php echo $detailsID ?>", "navOffsets": { "nav": { "top": "30%" } } }'>
...
<div class="carousel-container carousel-nav-floated pos-rel <?php echo $detailsID ?>">
	...
	<div class="carousel-items row testimonials-details" data-threads-flickity='{ "prevNextButtons": false, "asNavFor": ".<?php echo $quotesID ?> [data-threads-flickity]" }'>
