...
<div class="carousel-container carousel-nav-left">
	...
	<div class="row">
		...
		<div class="col-md-3 col-xs-12 mb-4 mb-md-0">
			...
			<div class="carousel-items row testimonials-details w-100 row" data-threads-flickity='{ "asNavFor": ".<?php echo $quotesID ?>", "rightToLeft": true }'>
		...
		<div class="col-md-8 col-md-offset-1 col-xs-offset-0 col-xs-12">
			...
			<div class="carousel-items row testimonials-quotes row <?php echo $quotesID ?>" data-threads-flickity='{ "prevNextButtons": true, "navStyle": 2, "navOffsets": { "nav": { "left": 15 } }, "rightToLeft": true }'>
