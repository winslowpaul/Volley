...
<div id="<?php echo $this->get_id(); ?>" class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
	...
	<?php $this->get_top_text() ?>
		<div class="themethreads-counter-element <?php echo $this->get_counter_align(); ?>" data-enable-counter="true" <?php echo $this->get_data_options(); ?>>
				<?php $this->get_static_gradient(); ?>
				<?php $this->get_hover_gradient(); ?>
				<?php $this->get_count() ?>
		</div><!-- /.themethreads-counter-element -->
	<?php $this->get_bottom_text() ?>

</div><!-- /.themethreads-counter -->