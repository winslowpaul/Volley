...
class LD_Roadmap_Item extends LD_Shortcode {
	...
	public function __construct() {
		...
		$this->title           = esc_html__( 'Roadmap Item', 'volley-core' );
		$this->description     = esc_html__( 'Add Roadmap item', 'volley-core' );
	...
	public function get_params() {
		...
		$this->params = array(
			...
			array(
				'type'        => 'checkbox',
				'heading'     => esc_html__( 'Checked Item?', 'volley-core' ),
				'param_name'  => 'checked_item',
				'description' => esc_html__( 'If checked the icon with check mark will display', 'volley-core' ),
