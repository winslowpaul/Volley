...
class LD_Timeline_Item extends LD_Shortcode {
	...
	public function __construct() {
		...
		$this->title           = esc_html__( 'Timeline Item', 'volley-core' );
		$this->description     = esc_html__( 'Add timeline item', 'volley-core' );
	...
	public function get_params() {
		...
		$this->params = array(
			...
			array(
				...
				'description'      => esc_html__( 'Add subtitle to timeline item', 'volley-core' ),
				'edit_field_class' => 'vc_col-sm-6',
			),
			array(
				'type'             => 'textfield',
				'param_name'       => 'year',
				'heading'          => esc_html__( 'Timeline Year', 'volley-core' ),
				'description'      => esc_html__( 'Add year to timeline item', 'volley-core' ),
				'edit_field_class' => 'vc_col-sm-6',
			),
			array(
