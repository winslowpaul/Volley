window.ThemeThreadsMultiPostThumbnails = {
    ...
    removeThumbnail: function(id, post_type, nonce){
	    jQuery.post(ajaxurl, {
		    ...
		    if ( str == '0' ) {
			    ...
			    ThemeThreadsMultiPostThumbnails.setThumbnailHTML(str, id, post_type);
		    }
	    }
	    );
    },
    ...
    setAsThumbnail: function(thumb_id, id, post_type, nonce){
	    ...
	    jQuery.post(ajaxurl, {
		    ...
		    if ( str == '0' ) {
			    ...
			    win.ThemeThreadsMultiPostThumbnails.setThumbnailID(thumb_id, id, post_type);
			    win.ThemeThreadsMultiPostThumbnails.setThumbnailHTML(str, id, post_type);
		    }
	    }
	    );
    }
