...
if( class_exists( 'ReduxFramework' ) ) {
	...
	class ThemeThreads_Use_Any_Font {
		...
		function __construct() {
			...
			add_filter( 'redux/themethreads_one_opt/field/typography/custom_fonts', array( $this, 'add_use_any_fonts_to_redux') );
