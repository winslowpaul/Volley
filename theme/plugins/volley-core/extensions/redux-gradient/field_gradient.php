...
if ( ! class_exists( 'ReduxFramework_gradient' ) ) {
    class ReduxFramework_gradient {
        ...
        function render() {
			...
			printf( '<input type="text" class="hidden themethreads-gradient-css">', $this->field['id'] );
			printf( '<select class="themethreads-gradient-direction">' . 
            ...
            printf( '<div id="%1$s-gradient" class="themethreads-gradient"></div>', $this->field['id'] );
            printf( '<div class="themethreads-gradient-preview"><div class="themethreads-gradient-preview-inner"></div></div>', $this->field['id'] );
        }
