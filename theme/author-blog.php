<?php
/**
 * ThemeThreads_AuthorBlog class for blog posts page and blog archives
 */

class ThemeThreads_AuthorBlog extends LD_Blog {
	...
	public function __construct() {
		$this->atts = array(
			'style' => themethreads_helper()->get_option( 'author-blog-style' ),
			'enable_parallax' => themethreads_helper()->get_option( 'author-blog-enable-parallax' ),
			'show_meta' => themethreads_helper()->get_option( 'author-blog-show-meta' ),
			'meta_type' => themethreads_helper()->get_option( 'author-blog-meta-type' ),
			'one_category' => themethreads_helper()->get_option( 'author-blog-one-category' ),
			'post_excerpt_length' => themethreads_helper()->get_option( 'author-blog-excerpt-length' ),
			'grid_columns' => '2',
