...
class ThemeThreads_Theme_Assets extends ThemeThreads_Base {
    ...
    public function __construct() {
        ...
        $this->add_action( 'themethreads_before', 'add_head_vars', 0 ); 
    ...
    public function register() {
		...
		// Icons
		$this->style( 'themethreads-icons', $this->get_vendor_uri( 'themethreads-icon/themethreads-icon.min.css' ) );
		...
		//Theme Css
		$this->style( 'themethreads-base', get_template_directory_uri() . '/style.css' );
		$this->style( 'themethreads-light-scheme', $this->get_css_uri ( 'theme-scheme-light.min' ) );
		
		$this->style( 'themethreads-theme', $this->get_css_uri( 'theme' ) );
		$this->style( 'themethreads-responsive', $this->get_css_uri( 'theme-responsive' ) );
		$this->style( 'themethreads-rtl', $this->get_css_uri('theme-rtl.min' ) );

		//Custom Css
		$this->style( 'themethreads-custom', $this->get_css_uri( 'custom' ) );
    ...
    public function enqueue() {
		...
		//Base css files
		wp_enqueue_style( 'themethreads-base' );
		wp_enqueue_style( 'themethreads-theme' );
		wp_enqueue_style( 'themethreads-responsive' );

		if( is_rtl() ) {
			wp_enqueue_style( 'themethreads-rtl' );
		}


		if( 'light' === $page_color_scheme )  {
			wp_enqueue_style( 'themethreads-light-scheme' );	
		}
	...
	public function gutenberg() {
		...
		wp_enqueue_style( 'themethreads-gutenberg', $this->get_css_uri( 'theme-gutenberg' ) );

	}

	public function google_map_api_url() {

		$api_key = themethreads_helper()->get_theme_option( 'google-api-key' );
    ...
    public function script_data() {
        ...
        wp_localize_script( 'themethreads-theme', 'themethreadsTheme', self::$theme_json );
    }
