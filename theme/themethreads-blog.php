...
class ThemeThreads_ThemeBlog extends LD_Blog {
	...
	public function __construct() {
		$this->atts = array(
			'style'           => themethreads_helper()->get_option( 'blog-style' ),
			'enable_parallax' => themethreads_helper()->get_option( 'blog-enable-parallax' ),
			'show_meta'       => themethreads_helper()->get_option( 'blog-show-meta' ),
			'meta_type'       => themethreads_helper()->get_option( 'blog-meta-type' ),
			'one_category'    => themethreads_helper()->get_option( 'blog-one-category' ),
			'post_excerpt_length' => themethreads_helper()->get_option( 'author-blog-excerpt-length' ),
			'grid_columns' => themethreads_helper()->get_option( 'blog-columns' ),
